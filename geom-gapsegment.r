## Modified from geom-segment.r in the ggplot2 distribution
...
#'
#' `geom_gapsegment` draws a straight line between points (x, y) and
#' (xend, yend), leaving a gap at each end. 
#'
#' Draws a single segment/curve per case. See `geom_gappath` if you
